...
const AddYourProperty = () => {
    ...
    return (
        <div className='m-12 p-16 text-[var(--color12)] flex flex-col min-h-[80vh] justify-between bg-cover' id="add-your-property" style={backgroundStyle}>
            ...
            <div className='flex flex-row justify-between pb-4 pt-4'>
                <div className='flex flex-col pr-6 '>
                    <CgProfile className='text-[var(--color2)] text-4xl'/>
                    <p className='text-[var(--color2)] pt-2 pb-4'>Register</p>
                    <p>Join our community and unlock the potential to sell your property to eager buyers.</p>
                </div>
                <div className='flex flex-col pr-6'>
                    <TfiWrite className='text-[var(--color2)] text-4xl'/>
                    <p className='text-[var(--color2)] pt-2 pb-4'>Fill Up Property Details</p>
                    <p>Provide comprehensive details about your property to attract the right audience effortlessly.</p>
                </div>
                <div className='flex flex-col  pr-6'>
                    <IoCheckmarkDoneCircleOutline className='text-[var(--color2)]  text-4xl'/>
                    <p className='text-[var(--color2)] pt-2 pb-4'>You Are Done</p>
